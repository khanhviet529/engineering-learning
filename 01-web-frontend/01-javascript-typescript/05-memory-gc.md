...
area: frontend
prerequisites:
  - 03-execution-context-closure.md
related:
...
- **Stream không đóng** — giữ buffer. Xem [Streams & buffers](../../02-backend-api/01-nodejs/02-streams-buffers.md).
...
- [Execution context & closure](03-execution-context-closure.md) — closure là nguồn leak
- [Process & memory (Node)](../../02-backend-api/01-nodejs/03-process-memory.md) — góc nhìn server
...
- [Effects & lifecycle](../02-react/02-effects-lifecycle.md) — cleanup trong React
