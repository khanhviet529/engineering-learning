...
- [TypeScript type system](02-type-system.md) — nền tảng
- [TypeScript ↔ runtime boundary](01-runtime-boundary.md) — type không bảo vệ dữ liệu ngoài
- [REST API contract](../../../02-backend-api/00-http-api/02-rest-api-contract.md) — type chia sẻ giữa FE và BE
- [Custom hooks](../../02-react/behavior/11-custom-hooks.md) — generic trong hook
