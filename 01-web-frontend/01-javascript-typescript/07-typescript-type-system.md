...
related:
  - 08-typescript-advanced-types.md
---
...
- [TypeScript ↔ runtime boundary](02-typescript-runtime-boundary.md) — type không kiểm tra dữ liệu ngoài
- [Advanced types](08-typescript-advanced-types.md) — generic, mapped, conditional
- [Server state & cache](../02-react/04-server-state-cache.md) — async state dưới dạng union
