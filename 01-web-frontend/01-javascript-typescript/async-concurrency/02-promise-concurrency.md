...
related:
  ...
  - ../../02-react/behavior/03-async-race-condition.md
...
| `Promise.all` 500 query tới DB có pool size 10 | Query xếp hàng; p99 tăng vọt. Xem [connection pool](../../../03-database/01-postgresql/fundamentals/02-connection-pool.md) |
...
- [Connection pool](../../../03-database/01-postgresql/fundamentals/02-connection-pool.md) — trần thực tế của concurrency
