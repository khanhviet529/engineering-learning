...
- Ở backend, dùng `class-validator` + `ValidationPipe` của NestJS ở tầng vào. Xem [Validation & errors](../../02-backend-api/02-nestjs/03-validation-errors.md).
...
- [TypeScript type system](07-typescript-type-system.md) — dùng type để mô hình hoá miền dữ liệu
- [Advanced types](08-typescript-advanced-types.md) — generic, mapped, conditional
- [Validation & errors (NestJS)](../../02-backend-api/02-nestjs/03-validation-errors.md) — validation ở backend
- [Error model](../../02-backend-api/00-http-api/05-error-model.md) — trả lỗi validation cho client
- [Modules & bundling](06-modules-bundling.md) — `import type` và circular dependency
