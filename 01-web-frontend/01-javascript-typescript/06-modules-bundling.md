...
related:
  ...
  - ../03-nextjs/01-server-client-boundary.md
---
...
| Import code chỉ dành cho server vào Client Component | Bundle chứa code server, hoặc build fail. Xem [Server/Client boundary](../03-nextjs/01-server-client-boundary.md) |
...
- **Circular import** → `undefined` tại thời điểm chạy, thường biểu hiện như "class không tồn tại". Trong NestJS thì là DI lỗi — xem [Modules & DI](../../02-backend-api/02-nestjs/02-modules-di.md).
