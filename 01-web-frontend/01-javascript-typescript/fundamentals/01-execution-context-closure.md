...
related:
  ...
  - ../runtime-behavior/01-memory-gc.md
---
...
A là đúng nhất khi có thể. Xem [Effects & lifecycle](../../02-react/behavior/02-effects-lifecycle.md).
...
Câu 8 là cầu nối sang [Memory & GC](../runtime-behavior/01-memory-gc.md): closure là nguyên nhân leak phổ biến nhất trong JS.
...
- Closure giữ tham chiếu ⇒ giữ object trong memory. Trong Node server, một closure trong cache/Map global có thể giữ cả request context, gây leak tăng dần. Xem [Process & memory](../../../02-backend-api/01-nodejs/production/01-process-memory.md).
...
- [Custom hooks](../../02-react/behavior/11-custom-hooks.md) — closure là nền của hook
- [TypeScript type system](../typescript/02-type-system.md) — type không bảo vệ khỏi lớp bug này
