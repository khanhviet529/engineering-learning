...
Xem [TypeScript type system](../01-javascript-typescript/07-typescript-type-system.md).
...
- [Type system](../01-javascript-typescript/07-typescript-type-system.md) — union cho state
