...
- Với Next.js App Router, chuyển việc nặng sang **server** thường hiệu quả hơn mọi tối ưu client. Xem [Rendering strategies](../03-nextjs/04-rendering-strategies.md).
...
- [Modules & bundling](../01-javascript-typescript/06-modules-bundling.md) — bundle size
- [Event loop](../01-javascript-typescript/01-event-loop-async.md) — long task
