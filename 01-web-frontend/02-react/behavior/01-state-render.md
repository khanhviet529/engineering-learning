...
area: frontend
prerequisites:
  - ../../01-javascript-typescript/fundamentals/01-execution-context-closure.md
related:
...
`setN` không gán vào biến `n`. Nó yêu cầu React render lại với giá trị mới. Biến `n` của render hiện tại là bất biến — đây chính là [closure](../../01-javascript-typescript/fundamentals/01-execution-context-closure.md) đang hoạt động, không phải một cơ chế riêng của React.
...
React so sánh bằng `Object.is`. Xem [immutability](../../01-javascript-typescript/fundamentals/03-error-handling-immutability.md).
...
- [Closure](../../01-javascript-typescript/fundamentals/01-execution-context-closure.md) — cơ chế đằng sau snapshot
- [Immutability](../../01-javascript-typescript/fundamentals/03-error-handling-immutability.md)
