...
related:
  - ../../01-javascript-typescript/fundamentals/03-error-handling-immutability.md
  - ../../03-nextjs/behavior/04-rendering-strategies.md
---
...
Không có `Suspense`, cả trang phải chờ query chậm nhất. Xem [Rendering strategies](../../03-nextjs/behavior/04-rendering-strategies.md).
...
- Trong Next.js, `error.tsx` và `loading.tsx` của App Router chính là ErrorBoundary và Suspense được đặt tự động theo route segment. Xem [Routing & layout](../../03-nextjs/behavior/02-routing-layout-rendering.md).
...
- [Rendering strategies (Next.js)](../../03-nextjs/behavior/04-rendering-strategies.md) — streaming với Suspense
- [Routing & layout](../../03-nextjs/behavior/02-routing-layout-rendering.md) — `error.tsx`, `loading.tsx`
