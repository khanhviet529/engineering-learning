...
- [Closure](../01-javascript-typescript/03-execution-context-closure.md) — cơ chế nền
- [Advanced types](../01-javascript-typescript/08-typescript-advanced-types.md) — generic cho hook
