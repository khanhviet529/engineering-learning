...
1. [Event loop & async](01-javascript-typescript/01-event-loop-async.md) — nền của mọi thứ async
2. [Execution context & closure](01-javascript-typescript/03-execution-context-closure.md) — stale closure không phải bug của React
3. [TypeScript ↔ runtime boundary](01-javascript-typescript/02-typescript-runtime-boundary.md) — type không kiểm tra response API
4. [Async race condition](02-react/03-async-race-condition.md) — bug bạn không thấy trên localhost
5. [Server/Client boundary](03-nextjs/01-server-client-boundary.md) — câu hỏi "code này chạy ở đâu"
