...
Task move và rebalance dùng row locks đủ hẹp để không tạo duplicate position hoặc lost update. Không giữ transaction mở khi render XLSX, gửi email, gọi network hoặc thực hiện work queue; các hành vi queue/delivery chỉ thuộc Phase 1.2.
