...
- [ADR-0013: Thêm workspace member bằng lời mời qua email, không bằng tra cứu người dùng](ADR-0013-workspace-member-invitation.md) — **`Proposed`, chờ chủ dự án ký.** Một endpoint tra cứu "chỉ dành cho Workspace Admin" thực chất mở cho mọi người vừa đăng ký, vì ai xác minh email cũng tạo được workspace và thành admin của nó.
