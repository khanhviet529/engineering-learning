...
Xem [WebSocket gateway](../../../02-backend-api/02-nestjs/behavior/08-websocket-gateway.md).
...
- [Readiness & liveness](../scheduling-reliability/01-health-readiness-liveness.md) — probe quyết định rollout
- [Pod, Deployment, Service](01-pod-deployment-service.md) — ReplicaSet
- [Scheduling & resources](../scheduling-reliability/02-scheduling-resources.md) — PDB, capacity cho maxSurge
- [Debugging Kubernetes](../operations/02-debugging-k8s.md) — rollout treo
- [Graceful shutdown](../../../02-backend-api/01-nodejs/production/02-graceful-shutdown.md) — chuỗi shutdown đầy đủ
...
- [WebSocket gateway](../../../02-backend-api/02-nestjs/behavior/08-websocket-gateway.md) — kết nối dài
