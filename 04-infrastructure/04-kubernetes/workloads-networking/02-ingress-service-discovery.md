...
- [Readiness & liveness](../scheduling-reliability/01-health-readiness-liveness.md) — endpoints rỗng vì pod chưa ready
- [Debugging Kubernetes](../operations/02-debugging-k8s.md) — quy trình đầy đủ
- [Storage & StatefulSet](04-storage-statefulset.md) — headless Service cho StatefulSet
