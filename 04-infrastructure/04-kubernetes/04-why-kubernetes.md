...
- [Pod, Deployment, Service](01-pod-deployment-service.md) — ba khái niệm đầu tiên
- [Readiness & liveness](02-health-readiness-liveness.md) — health routing
- [Rollout & rollback](07-rollout-rollback.md) — deploy không downtime
- [Scheduling & resources](05-scheduling-resources.md) — scheduler đặt pod ở đâu
- [Autoscaling](09-autoscaling.md) — scale theo tải
