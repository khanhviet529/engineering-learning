...
Chỉ readiness được phản ánh trạng thái shutdown. Xem [Graceful shutdown](../../02-backend-api/01-nodejs/05-graceful-shutdown.md).
...
- [Pod, Deployment, Service](01-pod-deployment-service.md) — endpoints và readiness
- [Rollout & rollback](07-rollout-rollback.md) — readiness quyết định tốc độ rollout
- [Debugging Kubernetes](10-debugging-k8s.md) — CrashLoopBackOff
- [Graceful shutdown](../../02-backend-api/01-nodejs/05-graceful-shutdown.md) — readiness khi SIGTERM
