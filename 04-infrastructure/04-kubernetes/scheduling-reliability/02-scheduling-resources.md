...
area: infra
prerequisites:
  - ../operations/01-config-secrets-resources.md
related:
  - 03-autoscaling.md
...
- **Cluster Autoscaler hoặc Karpenter** với `maxReplicas`/giới hạn node rõ ràng — và nhớ giới hạn kết nối database. Xem [Connection pool](../../../03-database/01-postgresql/fundamentals/02-connection-pool.md).
...
- [Config, secrets & resources](../operations/01-config-secrets-resources.md) — requests/limits, QoS
- [Autoscaling](03-autoscaling.md) — HPA, VPA, Cluster Autoscaler
- [Rollout & rollback](../workloads-networking/03-rollout-rollback.md) — PDB và rolling update
- [Debugging Kubernetes](../operations/02-debugging-k8s.md) — pod Pending
- [Memory, CPU & limits](../../00-linux/02-memory-cpu-limits.md) — cgroup bên dưới
- [Storage & StatefulSet](../workloads-networking/04-storage-statefulset.md) — volume ảnh hưởng scheduling
- [Vì sao cần Kubernetes](../fundamentals/01-why-kubernetes.md) — scheduling là một trong năm việc
