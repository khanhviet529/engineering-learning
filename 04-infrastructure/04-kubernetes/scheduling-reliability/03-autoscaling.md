...
- [Scheduling & resources](02-scheduling-resources.md) — requests là nền của HPA và CA
- [Rollout & rollback](../workloads-networking/03-rollout-rollback.md) — PDB, capacity
- [Readiness & liveness](01-health-readiness-liveness.md) — readiness quyết định khi nào pod mới nhận traffic
- [Connection pool](../../../03-database/01-postgresql/fundamentals/02-connection-pool.md) — giới hạn thật của `maxReplicas`
- [Caching, queues & jobs](../../../02-backend-api/02-nestjs/behavior/07-caching-queues-jobs.md) — scale worker theo hàng đợi
