...
related:
  ...
  - ../../03-database/01-postgresql/06-wal-durability-backup.md
---
...
- [Scheduling & resources](05-scheduling-resources.md) — volume ảnh hưởng lên lịch
- [Ingress & service discovery](06-ingress-service-discovery.md) — headless Service cho StatefulSet
...
- [Replication & scaling](../../03-database/01-postgresql/09-replication-scaling.md) — failover, split-brain
- [Debugging Kubernetes](10-debugging-k8s.md) — pod Pending vì volume
