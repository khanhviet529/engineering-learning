...
Xem [Scheduling & resources](05-scheduling-resources.md).
...
- [Pod, Deployment, Service](01-pod-deployment-service.md) — endpoints, label
- [Readiness & liveness](02-health-readiness-liveness.md) — `Running 0/1`
- [Scheduling & resources](05-scheduling-resources.md) — Pending
- [Storage & StatefulSet](08-storage-statefulset.md) — PVC Pending, `--force`
- [Ingress & service discovery](06-ingress-service-discovery.md) — traffic không tới
- [Rollout & rollback](07-rollout-rollback.md) — rollout treo
