...
Xem [Backpressure](../../05-cross-cutting/performance/06-backpressure.md) và [Process & memory](../01-nodejs/03-process-memory.md).
...
- [Rollout & rollback](../../04-infrastructure/04-kubernetes/07-rollout-rollback.md) — kết nối dài gặp rolling update
- [Graceful shutdown](../01-nodejs/05-graceful-shutdown.md) — đóng gateway có trật tự
