...
Cái cuối là hệ quả trực tiếp của [TypeScript ↔ runtime boundary](../../../01-web-frontend/01-javascript-typescript/typescript/01-runtime-boundary.md).
...
- [Node runtime & concurrency](../../01-nodejs/fundamentals/01-runtime-concurrency.md) — chuỗi này chạy trên event loop nào
