...
area: backend
prerequisites:
  - ../../../01-web-frontend/01-javascript-typescript/fundamentals/02-modules-bundling.md
related:
  - ../../02-nestjs/behavior/02-modules-di.md
  - ../production/02-graceful-shutdown.md
---
...
Note này là góc **Node runtime + build backend**. Góc bundler/tree-shaking (barrel file, code splitting) ở [Modules & bundling](../../../01-web-frontend/01-javascript-typescript/fundamentals/02-modules-bundling.md) — đọc note đó trước.
...
`forwardRef` làm code chạy được nhưng vòng lặp vẫn còn — nó là dấu hiệu hai module đang gánh cùng một trách nhiệm. Xem [Modules & DI](../../02-nestjs/behavior/02-modules-di.md).
...
- [Modules & bundling](../../../01-web-frontend/01-javascript-typescript/fundamentals/02-modules-bundling.md) — góc bundler: tree-shaking, barrel file, code splitting
- [Modules & DI (NestJS)](../../02-nestjs/behavior/02-modules-di.md) — nơi circular import biến thành lỗi DI
- [TypeScript ↔ runtime boundary](../../../01-web-frontend/01-javascript-typescript/typescript/01-runtime-boundary.md) — cái gì bị xoá lúc compile
- [Node runtime & concurrency](01-runtime-concurrency.md) — runtime nạp module này
