...
Xem [Readiness & liveness](../../04-infrastructure/04-kubernetes/02-health-readiness-liveness.md).
...
- **Không đóng worker threads** → process không thoát. Xem [Worker threads](04-worker-threads-cpu.md).
...
- [Readiness & liveness](../../04-infrastructure/04-kubernetes/02-health-readiness-liveness.md) — vai của từng probe
- [Rollout & rollback](../../04-infrastructure/04-kubernetes/07-rollout-rollback.md) — rolling update
- [Worker threads](04-worker-threads-cpu.md) — phải `terminate()` khi shutdown
- [Process & memory](03-process-memory.md) — exit code 137 vs 143
- [Retry & DLQ](../../03-database/04-message-queues/03-retry-dlq.md) — job idempotent, checkpoint
- [Deployment & production (Next.js)](../../01-web-frontend/03-nextjs/08-deployment-production.md)
