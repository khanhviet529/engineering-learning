...
related:
  - ../../01-web-frontend/01-javascript-typescript/05-memory-gc.md
...
Quy trình tìm leak: chụp 2–3 snapshot cách nhau, so sánh ở chế độ *Comparison*, sort theo Delta, rồi xem **Retainers** của constructor tăng nhiều nhất. Chi tiết: [Memory & GC](../../01-web-frontend/01-javascript-typescript/05-memory-gc.md).
...
- [Memory & GC](../../01-web-frontend/01-javascript-typescript/05-memory-gc.md) — cơ chế GC và quy trình tìm leak
- [Node runtime & concurrency](01-node-runtime-concurrency.md) — event loop lag
- [Streams & buffers](02-streams-buffers.md) — external memory
- [Graceful shutdown](05-graceful-shutdown.md) — thoát đúng cách
...
- [Scheduling & resources](../../04-infrastructure/04-kubernetes/05-scheduling-resources.md) — requests vs limits
