...
- [Node runtime & concurrency](../fundamentals/01-runtime-concurrency.md) — vì sao đồng bộ chặn
- [Process & memory](../production/01-process-memory.md) — giới hạn heap và RSS
...
- [Memory & GC](../../../01-web-frontend/01-javascript-typescript/runtime-behavior/01-memory-gc.md)
