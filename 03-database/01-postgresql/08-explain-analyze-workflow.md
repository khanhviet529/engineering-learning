...
- [Index & query plan](02-index-query-plan.md) — vì sao planner chọn hay không chọn index
- [Index types](07-index-types.md) — chọn loại index đúng
- [MVCC & vacuum](04-mvcc-vacuum.md) — bloat làm `Buffers: read` cao; `Heap Fetches`
- [Joins & aggregation](../00-sql/02-joins-aggregation.md) — thuật toán join trong plan
- [Connection pool](03-connection-pool.md) — query nhanh vẫn chậm nếu chờ connection
