...
- [MVCC & vacuum](02-mvcc-vacuum.md) — `VACUUM FULL` và `ACCESS EXCLUSIVE`
- [Connection pool](../fundamentals/02-connection-pool.md) — transaction dài giữ cả connection lẫn khoá
- [Migrations](../../03-data-modeling/04-migrations.md) — DDL an toàn ở production
- [Index & query plan](../indexes-query-planning/01-index-query-plan.md) — `CREATE INDEX CONCURRENTLY`
