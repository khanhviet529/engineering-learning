...
[Index & query plan](02-index-query-plan.md) nói về B-tree và vì sao planner dùng hay không dùng index. Note này về **các loại index khác** và biến thể của B-tree, cho những câu hỏi mà B-tree thẳng không trả lời được.
...
- [Index & query plan](02-index-query-plan.md) — B-tree, sargable, vì sao planner từ chối index
- [EXPLAIN ANALYZE workflow](08-explain-analyze-workflow.md) — xác nhận index được dùng
- [MVCC & vacuum](04-mvcc-vacuum.md) — index thừa phá HOT update; index bloat
